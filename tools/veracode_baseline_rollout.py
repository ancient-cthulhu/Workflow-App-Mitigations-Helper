...
ASSET_FILES: dict[str, str] = {
    ...
    ".github/workflows/veracode-pipeline-scan.yml": ".github/workflows/veracode-pipeline-scan.yml",
    ".github/workflows/veracode-delta-scan.yml": ".github/workflows/veracode-delta-scan.yml",
    ".github/workflows/veracode-delta-mitigated-scan.yml": ".github/workflows/veracode-delta-mitigated-scan.yml",
}
